...
- ASDA-A2 and ASDA-A3 may have minor differences in certain registers. WCurrently only the default common base based of A2 is exposed
- DI and DO of CN1 are not exposed just yet.
