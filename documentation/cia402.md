...
| 604a:01 | U32  | `vl`                   | `vl`                                  | vl velocity quick stop numerator   |                                      |                                                                                                     |
| 604a:02 | U16  | `vl`                   | `vl`                                  | vl velocity quick stop denominator |                                      |                                                                                                     |
| 604b:01 | ?    | `vl`                   | `vl`                                  | vl velocity set-point numerator    |                                      |                                                                                                     |
| 604b:02 | ?    | `vl`                   | `vl`                                  | vl velocity set-point denominator  |                                      |                                                                                                     |
| 604c:00 | ?    | `vl`                   | `vl`                                  | vl velocity dimension numerator    |                                      |                                                                                                     |
| 604c:00 | ?    | `vl`                   | `vl`                                  | vl velocity dimension denominator  |                                      |                                                                                                     |
...
| 6062:00 | S32  |                        | `pp`, `ip`, others?                   | Position demand value              | add                                  | Input, showing state of motion controller                                                           |
| 6063:00 | S32  |                        |                                       | Actual location internal           | add                                  | Current position in internal units.  Encoder position?                                              |
...
| 60b9:00 | U16  |                        | `hm`                                  | Probe status                       | add optional pin                     |                                                                                                     |
...
| 60fc:00 | S32  |                        | `pp`, `hm`, `ip`                      | Position demand internal value     | add                                  |                                                                                                     |
