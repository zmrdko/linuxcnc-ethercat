...
| 604a:01 | U32  | `vl`                   | `vl`                                  | vl velocity quick stop numerator   | ADD RATIO MODPARAM                   |                                                                                                     |
| 604a:02 | U16  | `vl`                   | `vl`                                  | vl velocity quick stop denominator | ADD RATIO MODPARAM                   |                                                                                                     |
| 604b:01 | ?    | `vl`                   | `vl`                                  | vl velocity set-point numerator    | ADD RATIO MODPARAM                   |                                                                                                     |
| 604b:02 | ?    | `vl`                   | `vl`                                  | vl velocity set-point denominator  | ADD RATIO MODPARAM                   |                                                                                                     |
| 604c:00 | ?    | `vl`                   | `vl`                                  | vl velocity dimension numerator    | ADD RATIO MODPARAM                   |                                                                                                     |
| 604c:00 | ?    | `vl`                   | `vl`                                  | vl velocity dimension denominator  | ADD RATIO MODPARAM                   |                                                                                                     |
